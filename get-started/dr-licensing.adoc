...
* Adquira uma assinatura pré-paga (PAYGO) do * NetApp Intelligent Services* com o Amazon Web Services (AWS) Marketplace ou do Microsoft Azure Marketplace.
...
Após o término do teste gratuito, você pode comprar uma licença da NetApp ou assinar o * NetApp Intelligent Services* por meio do AWS Marketplace ou do Microsoft Azure Marketplace.  Este procedimento fornece uma visão geral de alto nível de como assinar diretamente em um dos Marketplaces.
...
+
Ou, no canto superior direito, selecione *Ver métodos de pagamento*.

+
image:dr-licensing-payment-methods.png["Página de métodos de pagamento para BlueXP disaster recovery"]

. Selecione *Assinar no AWS Marketplace* ou *Assinar no Azure Marketplace*.
. Use o AWS Marketplace ou o Microsoft Azure Marketplace para assinar o * NetApp Intelligent Services* e o * BlueXP disaster recovery*.
